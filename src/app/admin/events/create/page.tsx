    ...
    <Card className="border-none shadow-2xl rounded-[40px] overflow-hidden bg-zinc-950">
      ...
      <CardContent className="p-12 flex flex-col items-center min-h-100">
        ...
        <div className="w-full max-w-md mb-20 relative">
          <div className="h-2 bg-linear-to-r from-transparent via-emerald-500/50 to-transparent blur-sm" />
...
export default function CreateEventPage() {
  ...
  const onSubmit = async (data: any) => {
    ...
    if (!data.zones || data.zones.length === 0) {
      toast.error("Please add at least one ticket zone before publishing");
      return;
    }
  ...
  return (
    <div className="max-w-5xl mx-auto py-16 px-6 space-y-16 antialiased">
        ...
        <Card className="border border-zinc-100 shadow-[0_20px_60px_rgba(0,0,0,0.06)] rounded-[40px] overflow-hidden bg-white">
          ...
          <CardContent className="px-12 pb-14 space-y-14">
            ...
            <div className="space-y-4">
              ...
              <div className="relative group cursor-pointer h-105 rounded-[36px] border border-zinc-200 bg-linear-to-br from-zinc-50 to-zinc-100 overflow-hidden flex items-center justify-center transition-all duration-300 hover:shadow-xl">
                {imageUrlPreview ? (
                  <>
                    <Image
                      src={imageUrlPreview}
                ...
                {/* Hover overlay */}
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 backdrop-blur-sm rounded-[36px]">
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    placeholder="Born Pink World Tour..."
                  />
                </div>
              ...
              <div className="space-y-3">
                ...
                <Input
                  ...
                  placeholder="Rajamangala Stadium, Bangkok"
                />
              </div>
          ...
          <CardContent className="p-6 md:p-12 space-y-10 md:space-y-12">
            ...
            {fields.map((field, index) => {
              ...
              return (
                <div
                  key={field.id}
                  className="relative p-6 md:p-12 pt-16 md:pt-20 pr-6 md:pr-20 rounded-[40px] md:rounded-[50px] border border-zinc-100 bg-zinc-50/30 hover:border-emerald-200 transition-all duration-500 group"
                >
                  {/* Zone Badge */}
                  <div className="absolute -top-5 md:-top-6 left-6 md:left-12 bg-emerald-500 text-white px-6 py-2 rounded-full text-xs font-black tracking-widest shadow-lg">
                    ZONE {index + 1}
                  </div>
                  ...
                  <button
                    ...
                    className="absolute top-6 md:top-8 right-6 md:right-8 w-10 md:w-12 h-10 md:h-12 bg-white text-zinc-300 hover:text-rose-500 rounded-full flex items-center justify-center shadow-sm transition-all hover:scale-110 hover:bg-rose-50"
                  >
                    <Trash2 size={20} />
                  </button>
                  ...
                  <div className="grid gap-8 md:gap-12 lg:grid-cols-12">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex rounded-[20px] bg-zinc-100 p-1.5 gap-1.5">
                          {["standing", "seated"].map((type) => {
                            ...
                            return (
                              <button
                                ...
                                className={`
            flex-1 py-3.5 text-[10px] font-black tracking-widest
            rounded-[16px] transition-all duration-200
            ${
              isSelected
                ? "bg-white shadow-sm border border-zinc-300"
                : "bg-transparent hover:bg-zinc-200/60 text-zinc-500"
            }
          `}
                              >
                                {type.toUpperCase()}
                        ...
                        <div className="grid grid-cols-2 gap-6 animate-in slide-in-from-left-4">
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onInput={(e) => {
                                ...
                                // ถ้าผู้ใช้พิมพ์ตัวเลขและค่ามากกว่า 26 ให้ระบบปัดกลับมาเป็น 26 อัตโนมัติ
                                if (val !== "") {
                                  const num = parseInt(val, 10);
                                  if (num > 26) {
                                    e.currentTarget.value = "26";
                                  }
                                }
                              }}
                            />
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onInput={(e) => {
                                const val = e.currentTarget.value;
                                // ถ้าผู้ใช้พิมพ์ตัวเลขและค่ามากกว่า 100 ให้ระบบปัดกลับมาเป็น 100 อัตโนมัติ
                                if (val !== "") {
                                  const num = parseInt(val, 10);
                                  if (num > 100) {
      ...
      max-h-[500px] sm:max-h-[600px] md:max-h-[700px] lg:max-h-[580px] xl:max-h-[680px]
      overflow-x-auto overflow-y-auto scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-black
    "
                      >
                        <div className="p-6 md:p-8 min-w-[min-content]">
            ...
            <div className="flex justify-center pt-10">
              <Button
                ...
                className="rounded-2xl h-14 px-10 bg-gray-800 text-white font-black hover:bg-gray-900 shadow-xl shadow-gray-300!"
              >
